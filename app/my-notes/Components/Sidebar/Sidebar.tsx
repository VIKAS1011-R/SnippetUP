...
export default function Sidebar() {
  ...
  return (
    <div className={` ${openSideBar ? "fixed z-50 shadow-lg": "max-md:hidden"} ${openContentNote ? "hidden": "block"} pr-10 p-6 flex flex-col gap-2  pt-7 ${darkMode[1].isSelected?"bg-slate-900": "bg-white"} ${isMobile? "h-screen":""} border-r border-purple-600 `}>
      <Logo />
      <QuickLinks />
      <Languages />
    </div>
